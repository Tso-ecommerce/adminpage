<template>
 <div class="container-fluid">
    ...
    <div class="row">
          <div class="card col-12 col-md-6 col-lg-4 mx-auto" v-for="(product,index) in FilterProduct">
    ...
    setup(props){
        ...
        let FilterProduct = computed(()=>{
            return products.value.filter((product)=>{
                return product.category === props.tag;
            })
        })

        console.log(FilterProduct);

        return {load,products,FilterProduct}
    }
}
</script>
