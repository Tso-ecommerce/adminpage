<template>
  <div class="container-fluid">
    ...
    <div class="row" v-if="products.length">
          <div class="col-12 col-md-6 col-lg-4 mx-auto" v-for="(product,index) in products">
            <div class="card p-2">
              ...
              <div class="infoContainer">
                    ...
                    <div>
                      ...
                      <button class="btns" data-bs-toggle="modal" data-bs-target="#exampleModal">
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <p class="modaltext"> Are You Sure Want To Delete</p>
                          </div>
                          <div class="modal-footer">
                            <button type="button" class="btn-secondary" @click="deleteProduct(index)">Yes</button>
                            <button type="button" class="btn-primary" data-bs-dismiss="modal">No</button>
                          </div>
                        </div>
                      </div>
                    </div>
